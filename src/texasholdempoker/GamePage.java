...
public class GamePage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        computerBestHand.setText("Computer's best hand...");
        jLayeredPane1.add(computerBestHand, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 50, 230, 40));

        playerBestHand.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        playerBestHand.setForeground(new java.awt.Color(255, 255, 255));
        playerBestHand.setText("Player's best hand...");
        jLayeredPane1.add(playerBestHand, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 400, 230, 40));

        jLabel19.setForeground(new java.awt.Color(255, 255, 255));
        jLabel19.setText("Play's Best Hand:");
        jLayeredPane1.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 410, 110, 20));
        ...
        jLayeredPane1.add(computerDecision, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 0, 110, 40));

        jLabel15.setText("jLabel15");
        jLayeredPane1.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 420, -1, -1));

        jLabel20.setForeground(new java.awt.Color(255, 255, 255));
        jLabel20.setText("Difficulty Level:");
        jLayeredPane1.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 10, 80, 20));

        jLabel16.setForeground(new java.awt.Color(255, 255, 255));
        jLabel16.setText("Computer's Best Hand:");
        jLayeredPane1.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, 130, 20));
        ...
        jLayeredPane1.add(jButtonHelp, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 10, 70, -1));

        jLabelPlayerCard1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/texasholdempoker/images/52.png"))); // NOI18N
        ...
        jLayeredPane1.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 470, 50, -1));

        jLabelComputerCard1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/texasholdempoker/images/53.png"))); // NOI18N
        ...
        jLabelPlayerCard2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/texasholdempoker/images/52.png"))); // NOI18N
        jLayeredPane1.add(jLabelPlayerCard2, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 360, 70, 100));

        jLabelComputerCard2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/texasholdempoker/images/53.png"))); // NOI18N
        ...
        jLayeredPane1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 10, 120, -1));

        jTextFieldDisplayWinner.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jTextFieldDisplayWinner.setForeground(new java.awt.Color(255, 255, 255));
        jTextFieldDisplayWinner.setText("The Winner Will Display Here");
        jLayeredPane1.add(jTextFieldDisplayWinner, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 240, 230, 30));

        jLabelCommunityCard1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/texasholdempoker/images/52.png"))); // NOI18N
        jLayeredPane1.add(jLabelCommunityCard1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 210, 70, 100));

        jLabelCommunityCard2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/texasholdempoker/images/52.png"))); // NOI18N
        ...
        jLayeredPane1.add(jLabelPlayerName, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 470, 270, -1));

        jLabelCommunityCard3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/texasholdempoker/images/52.png"))); // NOI18N
        jLayeredPane1.add(jLabelCommunityCard3, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 210, 70, 100));

        jLabelCommunityCard4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/texasholdempoker/images/52.png"))); // NOI18N
        jLayeredPane1.add(jLabelCommunityCard4, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 210, 70, 100));

        jLabelCommunityCard5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/texasholdempoker/images/52.png"))); // NOI18N
        ...
        jLayeredPane1.add(jButtonRaise, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 320, 70, -1));
        ...
        jLayeredPane1.add(jButtonFold, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 320, 60, -1));
        ...
        jLayeredPane1.add(jTextFieldPlayerBet, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 460, 150, 30));
        ...
        jLayeredPane1.add(jTextFieldComputerBet, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 10, 150, 30));

        jButtonNewRound.setBackground(new java.awt.Color(153, 255, 153));
        jButtonNewRound.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jButtonNewRound.setText("Shuffle & New Round");
        ...
        jLayeredPane1.add(jButtonCall, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 320, 60, -1));

        jLabel14.setForeground(new java.awt.Color(255, 255, 255));
        jLabel14.setText("Victor:");
        jLayeredPane1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 210, 60, 20));

        jTextFieldWinner.setIcon(new javax.swing.ImageIcon(getClass().getResource("/texasholdempoker/pagegameimage.jpg"))); // NOI18N
